# -*- coding: utf-8 -*-
__title__ = "Rename\nWorkset"
__doc__ = u"Renomeia os worksets do projeto com uma interface visual."
...
if not doc.IsWorkshared:
    forms.alert(u"Este projeto não usa worksharing.", exitscript=True)
...
if not worksets:
    forms.alert(u"Nenhum workset encontrado.", exitscript=True)
    ...
    <Border Padding="16">
        <Grid>
            ...
            <TextBlock Grid.Row="1"
                       Text="Edite os nomes na coluna da direita:"
...
if not renames:
    forms.alert(u"Nenhuma alteração feita.")
    script.exit()

# ---------- Renomear ----------
renamed = 0
with revit.Transaction(u"Renomear worksets"):
