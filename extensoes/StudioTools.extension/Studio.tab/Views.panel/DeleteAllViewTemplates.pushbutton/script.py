...
__doc__ = "Exclui templates de vista do projeto atual, com uma janela de seleção."
...
if not templates:
    forms.alert("Nenhum template de vista encontrado no projeto.", exitscript=True)
...
<Window xmlns="http://schemas.microsoft.com/winfx/2006/xaml/presentation"
        ...
        Title="Excluir templates de vista"
    ...
    <Border Padding="16">
        <Grid>
            ...
            <TextBlock Grid.Row="0" Text="EXCLUIR TEMPLATES DE VISTA" FontSize="15"
                       FontWeight="Bold" Foreground="#2C3E50" Margin="0,0,0,8"/>

            <TextBlock Grid.Row="1" Text="Selecione os templates a excluir:"
                       FontSize="12" Foreground="#555" Margin="0,0,0,6"/>

            <StackPanel Grid.Row="2" Orientation="Horizontal" Margin="0,0,0,6">
                <Button x:Name="btn_all" Content="Selecionar tudo"
                        Width="110" Height="24" FontSize="11" Margin="0,0,6,0"/>
                <Button x:Name="btn_none" Content="Limpar seleção"
                        Width="110" Height="24" FontSize="11" Margin="0,0,6,0"/>
            ...
            <StackPanel Grid.Row="5" Orientation="Horizontal"
                ...
                <Button x:Name="btn_delete" Content="Excluir" Width="100" Height="30"
...
class DeleteTemplatesUI(object):
    def __init__(self):
        ...
        self.tb_count.Text = "0 de {} selecionado(s)".format(len(self.all_names))
    ...
    def on_selection(self, sender, args):
        ...
        self.tb_count.Text = "{} de {} selecionado(s)".format(
...
# ---------- Confirmar ----------
confirm = forms.alert(
    "Tem certeza de que quer excluir {} template(s) de vista?".format(len(ui.selected)),
    yes=True,
    no=True,
)
if not confirm:
...
# ---------- Excluir ----------
deleted = 0
with revit.Transaction("Excluir templates de vista"):
...
forms.alert("{} template(s) de vista excluído(s).".format(deleted))
