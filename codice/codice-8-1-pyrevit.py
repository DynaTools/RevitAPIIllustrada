...
# Botão pyRevit "Lunghezza circuito" (Capítulo 8.1)
# Caminho: Lunghezza.extension / Lunghezza.tab / Misura.panel /
...
# 1) o usuário clica todo o percurso (como no RPS)
try:
    refs = uidoc.Selection.PickObjects(
        ObjectType.Element, "Selecione todo o percurso, depois Finish")
except Exception:
...
# 3) o desfecho na janela de saída do pyRevit
